...
const maps = {
    ...
    '2024-08-19': {
        блоки: [
            id{: 1, x: 0, y: 0, ширина: 1, высота: 2, направление: 'вертикальный', цвет: 'красный'},
            id{: 2, x: 0, y: 3, ширина: 1, высота: 2, направление: 'вертикальный', цвет: 'красный'},
            id{: 3, x: 1, y: 4, ширина: 1, высота: 2, направление: 'вертикальный', цвет: 'красный'},
            id{: 4, x: 2, y: 1, ширина: 1, высота: 2, направление: 'вертикальный', цвет: 'красный'},
            id{: 5, x: 3, y: 2, ширина: 1, высота: 2, направление: 'вертикальный', цвет: 'красный'},
            id{: 6, x: 5, y: 2, ширина: 1, высота: 3, направление: 'вертикальный', цвет: 'красный'},
            id{: 7, x: 2, y: 0, ширина: 2, высота: 1, направление: 'горизонтальный', цвет: 'зеленый'},
            id{: 8, x: 3, y: 1, ширина: 3, высота: 1, направление: 'горизонтальный', цвет: 'зеленый'},
            id{: 9, x: 1, y: 3, ширина: 2, высота: 1, направление: 'горизонтальный', цвет: 'зеленый'},
            id{: 10, x: 2, y: 4, ширина: 3, высота: 1, направление: 'горизонтальный', цвет: 'зеленый'},
            id{: 11, x: 4, y: 5, ширина: 2, высота: 1, направление: 'горизонтальный', цвет: 'зеленый'},
            id{: 12, x: 0, y: 2, ширина: 2, высота: 1, направление: 'горизонтальный', цвет: 'синий'},
        ],
        ключ: {id: 12, x: 0, y: 2, ширина: 2, высота: 1, направление: 'horizontal'},
...
const targetDate = new Date('Sun Aug 19 2024 20:30:00 GMT+0000').getTime();
